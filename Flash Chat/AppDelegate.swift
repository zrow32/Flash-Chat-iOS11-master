...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        FirebaseApp.configure()  // be sure not to loose this line!!!
        
//        let myDataBase = Database.database().reference()        These 2 line were just to test if we get data into database
//        myDataBase.setValue("ahalksdjhgladsh")
